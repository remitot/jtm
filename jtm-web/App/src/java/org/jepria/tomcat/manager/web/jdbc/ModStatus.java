...
public class ModStatus {
  ...
  public static final int CODE_ERR__CONNECTION_NOT_FOUND_BY_LOCATION = 1;
  ...
  public static ModStatus errConnectionNotFoundByLocation(String location) {
    return new ModStatus(CODE_ERR__CONNECTION_NOT_FOUND_BY_LOCATION, "ERROR: no connection found by location '" + location + "'"); 
  }
